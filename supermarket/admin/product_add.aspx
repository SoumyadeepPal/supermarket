<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminAccount.Master" AutoEventWireup="true" CodeBehind="product_add.aspx.cs" Inherits="supermarket.admin.product_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="account-head">
            ...
            <li class="tab">
                <a class="tab-title" href="/admin/products.aspx" aria-selected="false" tabindex="0">View All Product</a>
            </li>
                <li class="tab is-active">
                    <a class="tab-title" href="/admin/product_add.aspx" aria-selected="true" tabindex="0">Add New Product</a>
                </li>
        </ul>
        ...
        <div class="col-lg-9" >
          <h1 class="heading1"><span class="maintext">Add New product Details</span></h1>
          <div class="form-horizontal">
            ...
            <div class="registerbox">
                ...
                <div class="form-field">
                  ...
                  <div class="controls">
                      <asp:FileUpload ID="fuProductImg2" runat="server" />
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Required Field" ControlToValidate="fuProductImg2" Display="Dynamic"></asp:RequiredFieldValidator>
                      <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="CustomValidator" Display="Dynamic" ControlToValidate="fuProductImg2"></asp:CustomValidator>                    
                  </div>
                </div>
                ...
                <div class="form-field">
                  ...
                  <div class="controls">
                      <asp:FileUpload ID="fuProductImg3" runat="server" />
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Required Field" ControlToValidate="fuProductImg3" Display="Dynamic"></asp:RequiredFieldValidator>
                      <asp:CustomValidator ID="CustomValidator3" runat="server" ErrorMessage="CustomValidator" Display="Dynamic" ControlToValidate="fuProductImg3"></asp:CustomValidator>
                  </div>
                </div>
                ...
                <!--<div class="form-field">
                  ...
                  <div class="controls">
                      <asp:FileUpload ID="fuProductImg4" runat="server" />
                ...
                <div class="form-field">
                  ...
                  <div class="controls">
                      <asp:FileUpload ID="fuProductImg5" runat="server" />
                ...
                <div class="form-field">
                  <label class="form-label">
                      ...
                      <asp:DropDownList ID="CategoryList" runat="server" CssClass="form-select"></asp:DropDownList>
...
"></asp:Label>
                  ...
                  <div class="form-actions">
                      <asp:Button ID="btnProductAdd" runat="server" Text="Add Product" CssClass="button button--primary" OnClick="btnProductAdd_Click"/>
				</div>
        </div>
