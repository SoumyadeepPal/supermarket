<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="supermarket.register" %>
        ...
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li class="breadcrumb is-active">
                    <span class="breadcrumb-label">Create Account</span>
                </li>
            </ul>
                ...
                <div class="account-body">
                    <div class="form-row form-row--half">
                        ...
                        <div class="form-field form-field--input form-field--inputPassword">
                            ...
                            <asp:TextBox ID="repass_ip" runat="server" CssClass="form-input" TextMode="Password"></asp:TextBox>
                        ...
                        <div class="form-field form-field--input form-field--inputText">
                            <label class="form-label">
                                <asp:Label ID="ph" runat="server" Text="Phone Number"></asp:Label>
                                <small>Required</small>
                            </label>
                    ...
                    <div class="form-actions">
                        <asp:Button ID="Button1" runat="server" Text="Create Account" CssClass="button button--primary" CausesValidation="False" OnClick="Button1_Click" />
                    </div>
                </div>
            </div>
