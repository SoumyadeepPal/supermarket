                                    ...
                                    <asp:FormView ID="FormView1" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <asp:Image ID="imgProduct4" runat="server" ImageUrl='<%# Eval("product_image4") %>' CssClass="img-thumbnail" AlternateText="No Image" />
                                            ...
                                            <div class="control-group">
                                                ...
                                                <asp:Image ID="imgProduct5" runat="server" ImageUrl='<%# Eval("product_image5") %>' CssClass="img-thumbnail" AlternateText="No Image" />
