<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminAccount.Master" AutoEventWireup="true" CodeBehind="category_add.aspx.cs" Inherits="supermarket.admin.category_add" %>
    ...
    <div class="row">
            ...
            <li class="tab">
                ...
                <li class="tab is-active">
                    ...
                    <!-- Add Product Section-->
                    <div class="col-lg-9">
                        <h1 class="heading1"><span class="maintext">Add New Category Details</span></h1>
                  ...
                  <div class="controls">
                                ...
                                <div class="form-actions">
                                    <asp:Button ID="btnCategoryAdd" runat="server" Text="Add Category" CssClass="button button--primary" OnClick="btnCategoryAdd_Click" />
                                </div>
                            </div>
